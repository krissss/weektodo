...
export default {
  create(vue) {
    ...
    const today_id = moment().format('YYYYMMDD')
    const tomorrow_id = moment().add(1, 'd').format('YYYYMMDD')
    const after_tomorrow_id = moment().add(2, 'd').format('YYYYMMDD')
    const custom_list1_id = create_custom_list(vue, vue.$t('generatedData.list1'))
    const custom_list2_id = create_custom_list(vue, vue.$t('generatedData.list2'))
